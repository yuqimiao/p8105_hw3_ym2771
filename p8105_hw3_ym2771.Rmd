...
In 2002, there are overall 6 states having 7 or more locations, while in 2010, the number of states having 7 or more locations had increased to `r nrow(states_with_7m)-1`, and the overlapping states are `r states_with_7m %>% drop_na() %>% pull(locationabbr)`
